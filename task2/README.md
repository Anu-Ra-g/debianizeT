...
7. Wrote a python script using **pandas** to group the strace logs into two html files: 
    - [inproject](/assets/in-project.html) (folder inside which lintian-brush was called)
    - [overall](/assets/overall.html) (total overall files that were read throughout the system)
